...
| `lib/pages/products_page.dart` | 🧹 Suppression variable inutilisée | ✅ |
...
| `lib/pages/__login_page.dart` | Non requis MVP |
| `lib/pages/__registration_page.dart` | Non requis MVP |
