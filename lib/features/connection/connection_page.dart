...
class _ConnectionPageState extends State<ConnectionPage> {
  ...
  void initState() {
    super.initState();
    final connection = context.read<OdooProvider>().connection;
  ...
  Future<void> _connect() async {
    ...
    await context.read<OdooProvider>().connect(
      ...
      body: Center(
        child: ConstrainedBox(
          ...
          child: SingleChildScrollView(
            ...
            child: Consumer<OdooProvider>(
              builder: (context, provider, _) {
                final connecting = provider.state == OdooConnectionState.connecting;
                return Form(
                  key: _formKey,
                  child: Column(
                    ...
                    children: [
                      ...
                      FilledButton.icon(
                        ...
                        label: Text(connecting ? 'A testar conexão…' : 'Testar conexão'),
                      ),
                      if (kDebugMode) ...[
                        const SizedBox(height: 12),
                        OutlinedButton(
                          onPressed: connecting
                              ? null
                              : () => context.read<OdooProvider>().enterDemoMode(),
